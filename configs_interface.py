...
class DataConfigs(BaseModel):
    test_date_rate: float = 0.3
    DATASET: str = "police"
    stop_words: str = 'HIT_stop_words.txt'
    LABEL_NAME_FILE: str = "label_names.txt"
    TRAIN_CORPUS: str = "train_small.txt"
    TEST_CORPUS: str = "test_small.txt"
    TRAIN_LABEL: str = "train_labels_small.txt"
    TEST_LABEL: str = "test_labels_small.txt"
